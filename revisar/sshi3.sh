...
#Última edição: 08/06/2017 09:43
...
sleep 2; clear
	echo "Bem-Vindo ao BETA SSHi3 === Versã 1.0 "
else
...
sleep 3; clear
			...
			then
				...
				sed -i 's/Port '$portalta'/Port '$port'/g' /etc/ssh/sshd_config
...
sleep 5; clear
	...
	0)
		...
		echo
		echo -e $padrao
		echo "Felipe Almeida (BloodRoyale), Jéssica Carriel (Pudimzinho)"
		echo
		echo -e $green
		echo "##########################"
